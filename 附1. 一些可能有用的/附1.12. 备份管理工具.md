...
To select the JobIds, you have the following choices:
    ...
    13: Cancel
Select item: (1-13): 5     # select 5 as an example (most recent backup)
...
cwd is: /
$ ls # display backuped file list
home/
$ mark home # mark target file to restore
5 files marked.
$ lsmark # confirm marked file
*home/
  *cent/
    *.bash_logout
    *.bash_profile
...
*exit     # quit
[root@node01 ~]# ls -laR /tmp/bacula-restores 
/tmp/bacula-restores:
total 4
