...
[iptables](https://www.netfilter.org/projects/iptables/)是与Linux内核集成的IP信息包过滤系统。红帽上的[iptables使用指南](https://access.redhat.com/documentation/zh-cn/red_hat_enterprise_linux/7/html/security_guide/sec-using_firewalls#sec-Using_iptables)。
