...
`ansible target_servers -m shell -a "rpm -qa | grep -E 'vim-enhanced|wget|unzip'" --ask-become-pass` # 确认设置
...
要使用“when”，“failed_when”，可以在Ansible Playbook中写入分支条件。
...
![ansible-directory-tree](../Contents/ansible-directory-tree.png)
