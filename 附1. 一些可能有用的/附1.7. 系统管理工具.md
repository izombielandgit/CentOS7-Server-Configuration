...
[Virtualmin](http://www.webmin.com/virtualmin.html)是一个Webmin的模块，用于[Apache httpd](../5. Web服务器/5.1. Apache httpd.html)或[Postfix](../9. 邮件服务器/9.1. 安装Postfix.html)的虚拟主机的管理和设置。
