...
|log_client_versiojn|varchar(20)|
...
sqlcmd -S $HOST -U $USER -P $PASS -d $DB -Q "update status set user_online=0,last_logout=getdate(),last_total=$bytes_received+$bytes_sent,total_received=total_received+$bytes_received,total_sent=total_sent+$bytes_sent,grand_total=grand_total+$bytes_received+$bytes_sent where user_id='$common_name'"
