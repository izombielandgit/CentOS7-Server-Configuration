...
* [2.1. KVM](../2. 虚拟化/2.1. KVM.html)
  ...
  * [2.1.10. 快照管理](../2. 虚拟化/2.1. KVM.html#2110-快照管理)
* [2.2. oVirt](../2. 虚拟化/2.2. oVirt.html)
  * [2.2.1. 配置控制服务器](../2. 虚拟化/2.2. oVirt.html#221-配置控制服务器)
  * [2.2.2. 配置节点](../2. 虚拟化/2.2. oVirt.html#222-配置节点)
  * [2.2.3. 添加管理的目标节点](../2. 虚拟化/2.2. oVirt.html#223-添加管理的目标节点)
...
* [2.4. Docker](../2. 虚拟化/2.4. Docker.html)
  * [2.4.1. 安装Docker](../2. 虚拟化/2.4. Docker.html#241-安装docker)
  * [2.4.2. 添加镜像](../2. 虚拟化/2.4. Docker.html#242-添加镜像)
  * [2.4.3. 访问容器](../2. 虚拟化/2.4. Docker.html#243-访问容器)
  * [2.4.4. 使用Dockerfile](../2. 虚拟化/2.4. Docker.html#244-使用dockerfile)
