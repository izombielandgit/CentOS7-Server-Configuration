...
配置存储虚拟机映像的存储服务器。存储服务器可以使用[NFS](https://www.server-world.info/en/note?os=CentOS_7&p=nfs&f=1)，[iSCSI](https://www.server-world.info/en/note?os=CentOS_7&p=iscsi&f=1)，[GlusterFS](https://www.server-world.info/en/note?os=CentOS_7&p=glusterfs&f=1)
