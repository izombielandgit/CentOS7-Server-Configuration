...
![run-virtual-machine-manager](../Contents/run-virtual-machine-manager.png)

单击“New”按钮（左上角的电脑图标），然后打开向导以创建新的虚拟机：

![new-virtual-machine.png](../Contents/new-virtual-machine.png)

指定虚拟机和安装源的名称。此示例选择本地媒体：

![virtual-machine-name](../Contents/virtual-machine-name.png)

选择安装介质或ISO映像，并指定操作系统类型和版本。Windows Server 2012没有被列出，可以选择Windows 2008来安装：

![virtual-machine-os-type](../Contents/virtual-machine-os-type.png)

指定内存大小和虚拟CPU数量：

![virtual-machine-memories](../Contents/virtual-machine-memories.png)

指定磁盘大小：

![virtual-machine-disks](../Contents/virtual-machine-disks.png)

打开“Advanced options”，确保网络等的设置正确：

![virtual-machine-ddvanced-options](../Contents/virtual-machine-ddvanced-options.png)

Windows Server 2012 R2安装开始：

![win12-installation-start](../Contents/win12-installation-start.png)
