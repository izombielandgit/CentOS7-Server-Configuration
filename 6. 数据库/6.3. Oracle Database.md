...
![oracle-net-listener1](../Contetns/oracle-net-listener1.png)

选中“Listener Configuration”框，然后转到下一步：

![oracle-net-listener2](../Contetns/oracle-net-listener2.png)

下一步：

![oracle-net-listener3](../Contetns/oracle-net-listener3.png)

设置侦听器的名称：

![oracle-net-listener4](../Contetns/oracle-net-listener4.png)

本例保持默认“TCP”：

![oracle-net-listener5](../Contetns/oracle-net-listener5.png)

设置端口，本例保持默认：

![oracle-net-listener6](../Contetns/oracle-net-listener6.png)

如果要创建更多侦听器，选择“Yes”。本例选择“No”：

![oracle-net-listener7](../Contetns/oracle-net-listener7.png)

配置完成：

![oracle-net-listener8](../Contetns/oracle-net-listener8.png)
